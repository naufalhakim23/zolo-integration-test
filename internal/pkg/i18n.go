...
var catalog = map[string]map[string]string{
	LangEN: {
		...
		MsgOrderExists:       "Order {order_id} has already been confirmed.",
		MsgOrderCreated:      "Order {order_id} was confirmed and is ready to sync.",
	...
	LangMS: {
		...
		MsgOrderExists:       "Pesanan {order_id} telah pun disahkan.",
		MsgOrderCreated:      "Pesanan {order_id} telah disahkan dan sedia untuk disegerakkan.",
